...
import { PortfolioRoadmap } from "@/components/portfolio-surface";

type PageProps = { params: Promise<{ slug: string }> };

export default async function PortfolioRoadmapPage({ params }: PageProps) {
  ...
  if (!data) notFound();
  return <PortfolioRoadmap data={JSON.parse(JSON.stringify(data))} />;
}
